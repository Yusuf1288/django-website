...
def add_cart(request, product_id):
    ...
    if current_user.is_authenticated:
        ...
        # This is where we get or create the cart before checking if the cart item exists
        try:
...
def cart(request, total=0, quantity=0, cart_items=None, tax=0,):
    ...
    return render(request, "appStore/cart.html",context)
...
def checkout(request, total=0, quantity=0, cart_items=None, tax=0,):
    ...
    return render(request, "appStore/checkout.html", context)
